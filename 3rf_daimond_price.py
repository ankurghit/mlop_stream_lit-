...
def main():
    ...
    depth = st.number_input("Depth", min_value=43, max_value=79, value=61.5, step=0.1)
    table = st.number_input("Table", min_value=43, max_value=95, value=57.0, step=0.1)
    area = st.number_input("Area", min_value=0, value=0)
